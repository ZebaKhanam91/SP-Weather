...
%   runid - char sequence to identify a given execution of the script
    ...
    addpath('/home/zk17735/caffe/matlab/demo/SP-Weather');
    addpath('/home/zk17735/models/');
    ...
    models = {sprintf('VGGNet16'),sprintf('VGGNet19') };
    ...
    features_base_dir = '/home/zk17735/extractedFeatures1';
    mkdir(features_base_dir);
    ...
    % directory
       ...
       for i=1:NoOfModels(2)
           ...
           feature_Model_dir = sprintf('%s/%s',features_base_dir,models{1,i});
           ...
           for j = 1:NoOfCategories(2)
               ...
               [code, code_v, code_neg, code_v_neg] = matdeeprep(models{1,i}, sprintf('/home/zk17735/SP/Dataset/Compress/ExtendedWeatherDatabase'),categories{1,j});
